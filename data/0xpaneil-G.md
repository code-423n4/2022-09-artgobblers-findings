...
3 Variable1 += (-=) variable2 is more expensive in gas cost than variable1 = Variable1 + (-) Variable2
...
4 To save gas it is better to use custom errors instead of REVERT()/REQUIRE(). Additionally, not characterizing strings saves the organization gas.
...
5 To save gas you should use privete for constants, don´t use public.
...
6 Use of uints/ints less than 32 Bytes (256 pieces) results in the foregoing problems.
...
8 Using storage for structs and arrays rather than Memory
